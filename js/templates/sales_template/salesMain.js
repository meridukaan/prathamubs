                        ...
                        "buttons":[
                        	{
                        		...
                        		'name' : ubsApp.getTranslation("CLOSE"),
                      			'action': "ubsApp.raiseAudioEvent(document.getElementById('closePopupButton'), 'saleEnd');ubsApp.closePopup();	ubsApp.stopTimer();ubsApp.closeCurrentScenario();ubsApp.callServerNextMove();"
                        	}
                        ]
                        });
    }
